        ...
        <div class="panel-wrap birchschedule">
            <table class="form-table">
                <tr class="form-field">
                    ...
                    <td>
                    <input type="checkbox" name="birs_service_client_type[]" value="0"><?php _e('Male', 'birchschedule'); ?>
                    ...
                    <br/>
                    <input type="checkbox" name="birs_service_client_type[]" value="1"><?php _e('Female', 'birchschedule'); ?>
                    ...
                    <br/>
                    <input type="checkbox" name="birs_service_client_type[]" value="2"><?php _e('Child', 'birchschedule'); ?>
